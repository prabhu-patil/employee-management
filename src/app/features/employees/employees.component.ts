...
@Component({
  ...
  template: `
    <main class="employees-page">
      ...
      <section *ngIf="viewMode === 'table'" class="employee-table-card">
        <div class="table-scroll">
          <table>
            ...
            <tbody *ngIf="!isLoading && animatedEmployees.length" @listAnimation>
              <tr
              ...
              >
                <td>
                  <div class="employee-cell">
                    <img *ngIf="emp.avatar_url" [src]="emp.avatar_url" [alt]="emp.full_name" />
                ...
                <td *ngIf="canManage">
                  <div *ngIf="confirmDeactivateId !== emp.id" class="actions">
                  ...
                  <div *ngIf="confirmDeactivateId === emp.id" class="confirm-actions">
                    <button type="button" class="danger-button" (click)="onDeactivate(emp.id)">Yes</button>
                    <button type="button" class="ghost-button" (click)="confirmDeactivateId = null">Cancel</button>
                  </div>
                </td>
              </tr>
            </tbody>
      ...
      <section *ngIf="viewMode === 'grid' && animatedEmployees.length" class="employee-grid" @listAnimation>
        <article
          *ngFor="let emp of animatedEmployees"
          class="employee-card card-hover"
        >
          <div class="card-top">
            <img *ngIf="emp.avatar_url" [src]="emp.avatar_url" [alt]="emp.full_name" />
          ...
          <div class="card-footer">
            ...
            <div *ngIf="canManage" class="actions">
              <button type="button" class="icon-button edit" aria-label="Edit employee" (click)="openEditModal(emp)">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9" /><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5Z" /></svg>
              </button>
              <button *ngIf="currentUserRole === 'admin'" type="button" class="icon-button delete" aria-label="Deactivate employee" (click)="confirmDeactivateId = emp.id">
